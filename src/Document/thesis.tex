...
%    \nocite{*}
    ...
    \input{common} %В этом файле лежат все команды для титульного листа

    \input{journal} %В этом файле команды для названий журналов
    \maketitle

    \include{annotation} % раздел "РЕФЕРАТ"
% ----------------------------------------------------------------
    \newpage
    \tableofcontents
    \include{designation} % раздел "ОБОЗНАЧЕНИЯ И СОКРАЩЕНИЯ"
% ----------------------------------------------------------------
    \input{intro} % раздел "ВВЕДЕНИЕ"

%\main % печатает заголовок "ОСНОВНАЯ ЧАСТЬ", не включается в курсовую работу
    \newpage
    \input{review} % раздел "Обзор литературы"
%\include{2} % раздел "Постановка задачи работы", не включается в курсоваую работу

%    \include{3} % раздел "Способы и методы теоретических и аналитических исследований"
    \input{modeling.tex}

%    \include{4} % раздел "Результаты и их обсуждение"
    \input{analisis.tex}

%    \input{concl} % раздел "ЗАКЛЮЧЕНИЕ"
    \input{result.tex}

    \bibliographystyle{Kourovkastyle.bst} %Стилевой файл для списка литературы в BibTeX
    \bibliography{References} % подключение списка литературы, сделанного в формате .bib

% ----------------------------------------------------------------
    \appendix % Раздел с Приложениями

    \include{appendix} % Файл с текстом приложения
